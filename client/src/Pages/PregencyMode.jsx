...
import { FiCalendar, FiActivity, FiZap, FiCamera, FiInfo, FiCheckCircle, FiChevronRight } from 'react-icons/fi';
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const res = await axios.get(`${process.env.REACT_APP_API_URL}/api/track/pregency/data`, 
